...
export default function IpvpnCompany() {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#010510] font-['Octa Brain','Avalont-Regular','sans-serif'] flex flex-col">
      ...
      {/* Hero Banner */}
      <div
        className="w-full  py-6 md:py-8 px-2 md:px-4 flex flex-col items-center justify-center relative overflow-hidden"
        style={{ minHeight: "240px" }}
      >
        <div className="absolute bg-[url('/assets/images/ip-banner-mobile.jpg')] md:bg-[url('/assets/images/ip-banner.jpg')] bg-no-repeat bg-center bg-cover inset-0 pointer-events-none z-0" />
      ...
      <div className="w-full max-w-6xl mx-auto px-2 md:px-4 mt-4 md:mt-8 flex flex-col gap-4 md:gap-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
          <div className="flex items-center gap-6 md:gap-4">
            <h2 className="text-xl md:text-5xl font-bold text-white tracking-widest font-heading">
              <Link
                className="text-white font-header"
                to={"/ipvpn"}
              >
                IPVPN
              </Link>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4 mt-1 md:mt-2">
          <div className=" items-center gap-2 md:gap-3 flex-wrap">
            <span className="px-2 py-0.5 md:px-3 md:py-1 font-body1 rounded bg-[#181F2F] text-[#A3AED0] text-xs font-semibold border border-[#232A3E]">
              VPN
            </span>
            <span className="mt-4 text-[#fff] text-xs md:text-base font-body1 block">
              A powerful and user-friendly VPN product designed to keep online
              activity private and data secure across the globe.
            </span>
            ...
            return (
              <button
                ...
                className={
                  ...
                  bg-none shadow-none rounded-none px-0 py-0 md:bg-inherit md:shadow-inherit
                  ` +
                  (isActive
        ...
        <div className="min-h-[220px] md:min-h-[320px] w-full flex items-center">
          {activeTab === 0 && (
            <div className="w-full flex flex-col md:flex-row gap-6 justify-center md:justify-start items-stretch">
              {/* Left Box: Daily Signals */}
              <Link to={"/ipvpn"}>
                <div
                  className="flex-1  border border-[#232A3E] rounded-2xl p-6 flex flex-col gap-4 relative shadow-xl"
                  style={{ minWidth: "340px", maxWidth: "500px" }}
                >
                  {/* Tabs and Rating */}
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex gap-2">
                      <button className="px-2 md:px-4 text-[14px] py-1 rounded-full font-body1 bg-[#232A3E] text-white md:text-sm font-semibold ring-1 ring-[#FFFFFF33]">
                        IPVPN
                      </button>
                    </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div className="flex-1 flex items-center justify-center order-1 md:order-2 mb-2 md:mb-0">
                      <img
                        src="./vpn.webp"
                        alt="chart"
                        className="rounded-lg border border-[#fff3] w-[307px] h-[134px] md:w-40 md:h-24 object-cover"
                      />
                    </div>
                    ...
                    <div className="flex-1 flex flex-col gap-2 justify-start items-start text-left order-2 md:order-1">
                      <div className="flex items-center gap-2 text-white text-sm">
                        <img
                          src="/assets/images/accuracy.png"
                          alt="accuracy"
                          className="w-5 h-5"
                        />
                        <span className="font-bold text-sm font-body1">
                          Uptime :
                        </span>
                        <span className="font-normal text-[#8c8c91] text-sm font-body1">
                          100%
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-white text-sm">
                        <img
                          src="/assets/images/signal-icon.png"
                          alt="signal"
                          className="w-5 h-5"
                        />
                        <span className="font-bold text-sm font-body1">
                      ...
                      <div className="flex items-center gap-2 text-white text-sm">
                        <img
                          ...
                          className="w-5 h-5"
                        />
                        <p className="font-bold text-sm font-body1 ">
                          Platform :{" "}
                          <span className="font-normal text-[#8c8c91] text-sm font-body1 ">
                  ...
                  <div className="flex justify-center mt-4">
                    <Link
                      to={"/ipvpn"}
                      className="text-center w-2/3 py-2 font-body1 rounded-full bg-gradient-to-r from-[#33A0EA] to-[#0AC488] text-white font-semibold text-base shadow-lg mt-10"
                    >
                      Subscribe
                    </Link>
                  </div>
          ...
          {activeTab === 2 && (
            <div className="w-full flex flex-col md:flex-row gap-6 items-stretch">
              ...
              >
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex gap-2">
                    <button className="px-2 md:px-4 text-[10px] py-1 rounded-full bg-[#232A3E] text-white md:text-xs font-semibold ring-1 ring-[#FFFFFF33]">
                      BTC/ETH
                    </button>
                    <button className="px-2 md:px-4 text-[10px] py-1 rounded-full bg-[#232A3E] text-white md:text-xs font-semibold ring-1 ring-[#FFFFFF33]">
                      Daily Signals
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center">
                  ...
                  <div className="flex-1 flex items-center justify-center order-1 md:order-2 mb-2 md:mb-0">
                    <img
                      src="/assets/images/ginox-signal.png"
                      alt="chart"
                      className="rounded-lg border border-[#fff3] w-[307px] h-[134px] md:w-40 md:h-24 object-cover"
                    />
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-2 justify-start items-start text-left order-2 md:order-1">
                    <div className="flex items-center gap-2 text-white text-sm">
                      ...
                      <span className="font-normal text-[#8c8c91] text-xs">
                        AES-256 encryption
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-white text-sm">
                      <img
                        ...
                        className="w-5 h-5"
                      />
                      <span className="font-bold text-xs">Servers :</span>
                      <span className="font-normal text-[#8c8c91] text-xs">
                        5000+
                      </span>
                    </div>
                ...
                <div className="flex justify-center mt-4">
                  <Link
                    to={"/ipvpn"}
                    className="text-center w-2/3 py-2 rounded-full bg-gradient-to-r from-[#33A0EA] to-[#0AC488] text-white font-semibold text-base shadow-lg mt-10"
                  >
                    Subscribe
                  </Link>
                </div>
