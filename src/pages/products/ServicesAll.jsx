            ...
            <div className="max-w-[422px] h-[268px] max-w-xl bg-[#101624]/80 border border-[#232A3E] rounded-2xl shadow-2xl p-8 relative flex flex-col gap-6 mx-auto md:ml-4 md:mx-0" style={{backgroundImage:'url("/assets/images/free-lottery-bg.png")',background:'rgba(0,0,0,0.1)'}}>
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                {/* <div className="flex items-center border border-[#FFFFFF33] gap-2 bg-[#232A3E] rounded-full px-5 py-2">
                  ...
                  <span className="text-[#fff] text-sm font-semibold">$3.9/month</span>
                </div> */}
              </div>
              {/* Divider */}
              {/* Info Grid */}
              <div className="grid bg-[#17171794] px-5 pt-2 rounded-xl grid-cols-2 gap-4 text-[#fff] text-sm">
                ...
                <div>
                  <div className="font-semibold text-[#fff] font-body1">Chains</div>
                  <div className="text-[#B6B6B6] text-xs mt-1 font-body1">Multiple Coins and Chains</div>
                </div>
              </div>
            </div>
          </Link>
            <Link to={'/ipvpn-company'}>
              <div className="max-w-[422px] h-[268px] max-w-xl bg-[#101624]/80 border border-[#232A3E] rounded-2xl shadow-2xl p-8 relative flex flex-col gap-6 mx-auto md:ml-4 md:mx-0" style={{backgroundImage:'url("/assets/images/free-lottery-bg.png")',background:'rgba(0,0,0,0.1)'}}>
                {/* Top Row: Logo and Price */}
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <img src="/assets/images/ipvpn.avif" alt="Crypto Signals Logo" className="h-8 w-auto" style={{filter:'brightness(1.2)'}} />
                  </div>
                  {/* <div className="flex items-center border border-[#FFFFFF33] gap-2 bg-[#232A3E] rounded-full px-5 py-2">
                    <img src="/assets/images/coin-icon.png" alt="coin" className="w-5 h-5" />
                    <span className="text-[#fff] text-sm font-semibold">$3.9/month</span>
                ...
                <div className="grid bg-[#17171794] px-5 pt-2 rounded-xl grid-cols-2 gap-4 text-[#fff] text-sm">
                  <div className='pb-4' style={{borderBottom:'1px solid #FFFFFF0F', borderRight:'1px solid #FFFFFF0F'}}>
                    <div className="font-semibold text-[#fff] font-body1">Uptime</div>
                    <div className="text-[#B6B6B6] text-xs mt-1 font-body1">100%</div>
                  </div>
                  <div style={{borderBottom:'1px solid #FFFFFF0F'}}>
                    <div className="font-semibold text-[#fff] font-body1">Security</div>
                    <div className="text-[#B6B6B6] text-xs mt-1 font-body1">Military-Grade</div>
                  </div>
                  <div className='pb-4' style={{borderRight:'1px solid #FFFFFF0F'}}>
                    <div className="font-semibold text-[#fff] font-body1">Platform</div>
                    <div className="text-[#B6B6B6] text-xs mt-1 font-body1">Windows, macOS, iOS, and Android</div>
                  </div>
                  <div>
                    <div className="font-semibold text-[#fff] font-body1">Servers</div>
                    <div className="text-[#B6B6B6] text-xs mt-1 font-body1">5000+</div>
                  </div>
                </div>
              </div>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <Link to={'/ipvpn-company'}>
              <div className="max-w-[422px] h-[268px] max-w-xl bg-[#101624]/80 border border-[#232A3E] rounded-2xl shadow-2xl p-8 relative flex flex-col gap-6 mx-auto md:ml-4 md:mx-0" style={{backgroundImage:'url("/assets/images/free-lottery-bg.png")',background:'rgba(0,0,0,0.1)'}}>
                ...
                <div className="grid bg-[#17171794] px-5 pt-2 rounded-xl grid-cols-2 gap-4 text-[#fff] text-sm">
                  <div className='pb-4' style={{borderBottom:'1px solid #FFFFFF0F', borderRight:'1px solid #FFFFFF0F'}}>
                    <div className="font-semibold text-[#fff]">Uptime</div>
                    <div className="text-[#B6B6B6] text-xs mt-1">100%</div>
                  </div>
                  <div style={{borderBottom:'1px solid #FFFFFF0F'}}>
                    <div className="font-semibold text-[#fff]">Security</div>
                    <div className="text-[#B6B6B6] text-xs mt-1">Military-Grade</div>
                  </div>
                  <div className='pb-4' style={{borderRight:'1px solid #FFFFFF0F'}}>
                    <div className="font-semibold text-[#fff]">Platform</div>
                    <div className="text-[#B6B6B6] text-xs mt-1">Windows, macOS, iOS, and Android</div>
                  </div>
                  <div>
                    <div className="font-semibold text-[#fff]">Servers</div>
                    <div className="text-[#B6B6B6] text-xs mt-1">5000+</div>
                  </div>
                </div>
              </div>
            </Link>
        ...
        {activeTab === 2 && (
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="max-w-[422px] h-[268px] max-w-xl bg-[#101624]/80 border border-[#232A3E] rounded-2xl shadow-2xl p-8 relative flex flex-col gap-6 mx-auto md:ml-4 md:mx-0" style={{backgroundImage:'url("/assets/images/free-lottery-bg.png")',background:'rgba(0,0,0,0.1)'}}>
              ...
              <div className="grid bg-[#17171794] px-5 pt-2 rounded-xl grid-cols-2 gap-4 text-[#fff] text-sm">
                <div className='pb-4' style={{borderBottom:'1px solid #FFFFFF0F', borderRight:'1px solid #FFFFFF0F'}}>
                  <div className="font-semibold text-[#fff]">Accuracy</div>
                  <div className="text-[#B6B6B6] text-xs mt-1">Up to 80% Claimed</div>
                </div>
                <div style={{borderBottom:'1px solid #FFFFFF0F'}}>
                  <div className="font-semibold text-[#fff]">Signal</div>
                  <div className="text-[#B6B6B6] text-xs mt-1">3-5 Day</div>
                </div>
                <div className='pb-4' style={{borderRight:'1px solid #FFFFFF0F'}}>
                  <div className="font-semibold text-[#fff]">Platform</div>
                  <div className="text-[#B6B6B6] text-xs mt-1">Telegram, Website</div>
                </div>
                <div>
                  <div className="font-semibold text-[#fff]">Chains</div>
                  <div className="text-[#B6B6B6] text-xs mt-1">Multiple Coins and Chains</div>
                </div>
              </div>
            </div>
          </Link>
