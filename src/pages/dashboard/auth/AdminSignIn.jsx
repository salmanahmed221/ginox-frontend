...
const AdminSignIn = () => {
  ...
  useEffect(() => {
    const performAdminSignIn = async () => {
      try {
        ...
        if (!token) {
          throw new Error("Token is required for admin sign-in");
        }

        if (!email) {
          throw new Error("Email is required for admin sign-in");
        }
        ...
        try {
          ...
          if (profileResponse.success && profileResponse.data) {
            console.log("Admin Sign-In - Profile data:", profileResponse.data);
            ...
            console.warn(
              "Admin Sign-In - Profile fetch failed:",
        ...
        setError(err.message || "Failed to perform admin sign-in");
        ...
        <div className="w-full max-w-lg bg-card_background rounded-[20px] shadow-2xl p-6 md:p-10 mx-auto border border-gray_line">
          {error ? (
            ...
            <div className="text-center">
              ...
              <div className="text-text_secondary text-xs font-body1">
